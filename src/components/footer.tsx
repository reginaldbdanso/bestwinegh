    ...
    <footer className="bg-muted py-12">
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-2">
                ...
                <span className="text-muted-foreground">123 Vineyard Lane, Wine Valley, CA 90210</span>
              </li>
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="text-muted-foreground">info@vineyardselections.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t mt-12 pt-6 text-center text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Vineyard Selections. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
